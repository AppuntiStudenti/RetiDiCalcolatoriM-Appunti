...
\begin{itemize}
 ...
 \item \textit{PIM}: Ragiona ad aree dense e aree in cui molte reti partecipano alla sottoscrizione (possiamo usare il flooding) e aree sparse in cui le reti interessate sono molto distanti.
...
\begin{itemize}
 ...
 in grado di servire le richieste, si utilizza broadcast in casi specifici.
