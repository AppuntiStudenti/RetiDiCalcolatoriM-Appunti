...
Tuttavia, la struttura dell'albero può inuenzare notevolmente l'efficienza dell'architettura.
...
specicati (FIFO, causal e atomic), ma inoltre è presente una particolare
