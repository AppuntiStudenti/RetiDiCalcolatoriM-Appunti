...
realizza un MOM è quindi un'overlay network, specificando quindi un sistema di nomi, routing...
...
Uno dei MOM più diffusi è MQSeries di IBM: questo realizza uno stub per ogni client, e introduce degli agenti che non
...
$\bullet$ Broker : si tratta di un gestore unificato per le connessioni. Viene quindi
