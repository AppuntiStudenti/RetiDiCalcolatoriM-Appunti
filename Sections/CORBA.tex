...
denita in maniera statica. Il binding fra client e servitore non è statico, qui si specifica solo
...
` necessario che sia il cliente a specificare il codice della callback da eseguire.
